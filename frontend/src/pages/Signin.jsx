...
const Signin = () => {
  ...
  const { isDarkMode, toggleDarkMode, signin, googleAuth, checkAuth } = userAuthStore();
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex flex-col items-center justify-center h-auto p-8 w-96 rounded-2xl border-2 
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="flex flex-col text-center items-center gap-3 w-3/4">
          ...
          <div className="relative w-full">
            <input
              ...
              className={`border-2 rounded w-full p-2 pr-10
                ${isDarkMode ? "bg-gray-600 border-gray-500 text-white" : "bg-white border-gray-300 text-black"}`}
              name="password"
